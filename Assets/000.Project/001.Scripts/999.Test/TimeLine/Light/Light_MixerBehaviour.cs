...
{
    public class Light_MixerBehaviour : PlayableBehaviour
    {
        public override void ProcessFrame(Playable playable, FrameData info, object playerData)
        {
            ...
            for (int i = 0; i < inputCount; i++)
            {
                ...
                ScriptPlayable<Light_Behaviour> inputPlayable = (ScriptPlayable<Light_Behaviour>)playable.GetInput(i);
                Light_Behaviour input = inputPlayable.GetBehaviour();
