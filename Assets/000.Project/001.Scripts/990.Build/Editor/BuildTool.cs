...
public partial class BuildTool : EditorWindow
{
    ...
    private const string LAUNCHER_RESOURCE_DIR = "Assets/000.Project/050.Launcher/Resources";

    private const string RESOURCE_DIR = "Assets/000.Project/Resources";
    private const string RESOURCE_TEMP_DIR = "Assets/000.Project/Resources_";
    private const string RESOURCE_MEDIA_DIR = "Assets/000.Project/Resources/Media";

    private const string STREAMING_DIR = "Assets/000.Project/StreamingAssets";
    private const string STREAMING_TEMP_DIR = "Assets/000.Project/StreamingAssets_";
    private const string STREAMING_MEDIA_DIR = "Assets/000.Project/StreamingAssets/Media";

    private const string CSV_DIR = "Assets/000.Project/Resources/CSV";
    private const string LUA_DIR = "Assets/000.Project/StreamingAssets/LuaScripts";

    private const string CSV_ZIP_PATH = "Assets/000.Project/csv.zip";
    private const string LUA_ZIP_PATH = "Assets/000.Project/lua.zip";
